...
import os
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'vcpzfv)709(r!8ld%a%j+=%5ce7$#0e2oxe#t+9d_v4@(364t0')
...
MIDDLEWARE = [
    ...
    'pillow.middleware.PillowMiddleware',
...
MEDIA_URL =  '/media/' # путь куда картинки сохранять для вывода изображен добавленых в админке
